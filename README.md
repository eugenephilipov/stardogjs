[![Build Status](https://travis-ci.org/ctco/react-template.svg?branch=master)](https://travis-ci.org/ctco/react-template)
...
- [12 Factor App configuration](cloud/azure#12-factor-app-configuration) 
 (`REACT_APP_`-prefixed env variables, being injected by application server
 (webpack dev server for development mode) at run-time,
 become accessible inside browser as `window.env.REACT_APP_...`)
